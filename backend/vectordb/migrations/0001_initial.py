    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('persistence_directory', models.CharField(blank=True, max_length=512)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module_vector_store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='vectordb.modulevectorstore')),
            ],
            options={
                'db_table': 'vectordb_task',
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['task_id'], name='vectordb_ta_task_id_44dfef_idx'), models.Index(fields=['status', '-created_at'], name='vectordb_ta_status_5114ae_idx'), models.Index(fields=['module_vector_store', '-created_at'], name='vectordb_ta_module__a19c6f_idx'), models.Index(fields=['created_by', '-created_at'], name='vectordb_ta_created_947507_idx')],
            },
        ),
    ]
